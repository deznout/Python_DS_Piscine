...
def check_nsp(dist, attr, value):
    ...
    for nsp in ns_packages:
        if not dist.has_contents_for(nsp):
            raise DistutilsSetupError(
                "Distribution contains no module or packages for " +
...
class Distribution(_Distribution):
    ...
    commands that add or remove packages, module, extensions, and so on from
    the distribution.
    """
    ...
    def exclude_package(self, package):
        """Remove packages, module, and extensions in named package"""
    ...
    def exclude(self, **attrs):
        ...
        packages, module, and extensions are also excluded.
    ...
    def iter_distribution_names(self):
        """Yield all packages, module, and extension names in distribution"""
